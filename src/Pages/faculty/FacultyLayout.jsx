...
const navItems = [
  ...
  { path: '/faculty/profile', label: 'My Profile', icon: '👤' },
];
  ...
  return (
    <div className="flex h-screen bg-emerald-50/50 overflow-hidden">
      ...
      <aside className={`fixed md:static inset-y-0 left-0 z-30 w-64 bg-gradient-to-b from-emerald-900 via-emerald-800 to-teal-900 text-white flex flex-col shadow-2xl transform transition-transform duration-200 ${sidebarOpen ? 'translate-x-0' : '-translate-x-full md:translate-x-0'}`}>
        <div className="p-5 border-b border-emerald-700/50">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-emerald-400 rounded-xl flex items-center justify-center font-black text-emerald-900 text-sm">👨‍🏫</div>
            <div>
        ...
        <div className="p-4 border-t border-emerald-700/50">
          <div className="flex items-center gap-3 mb-3">
            ...
            <div className="overflow-hidden">
              ...
              <p className="text-emerald-300 text-[10px] truncate">👨‍🏫 Faculty</p>
            </div>
          </div>
      ...
      <div className="flex-1 flex flex-col overflow-hidden min-w-0">
        ...
        <div className="flex-1 overflow-y-auto p-4 sm:p-6 bg-gradient-to-br from-emerald-50/50 to-slate-50">
          <Outlet />
        </div>
      </div>
    </div>
